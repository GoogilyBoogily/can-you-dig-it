...
// flatter than 45°. The dovetail rib and groove lean 56° and are the only downward faces
// meant to exist; a bridge or a flat underside is a joint on the wrong face.
const STEEPEST_OVERHANG = Math.cos(Math.PI / 4); // |n.z| of a 45° face
